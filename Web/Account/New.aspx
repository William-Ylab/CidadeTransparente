<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="Site.Account.New" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <ul class="breadcrumbs styler_bg_color">
            <li>
                <asp:Label ID="lblTitle" runat="server" Text='Cadastrar novo usuário'></asp:Label></li>
        </ul>
        ...
        <div class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:RadioButton ID="rbdOthers" runat="server" onclick="javascript: $('#formorganizacao').hide(); acceptTerms();" GroupName="userType" Checked="true" />
                    <span>
                        <asp:Literal ID="Literal20" Text='<%$Resources: Message, iam_a_common_user %>' runat="server" /></span>
                    &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbdEntity" runat="server" onclick="javascript: $('#formorganizacao').show(); acceptTerms();" GroupName="userType" />
                    <span>
                        <asp:Literal ID="Literal21" Text='<%$Resources: Message, iam_an_entity_user %>' runat="server" /></span>
                </div>
            </div>
            <fieldset>
                <legend>
                ...
                <div class="control-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal2" Text='<%$Resources: Message, name %>' runat="server" /></label>
                    <div class="controls">
                ...
                <div class="control-group" id="div_email">
                    <label class="control-label">
                        <asp:Literal ID="Literal1" Text='<%$Resources: Message, email %>' runat="server" /></label>
                    <div class="controls">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:DropDownList runat="server" ID="ddlRegion" CssClass="form-control input-lg validate[required]">
                            <asp:ListItem Text="Selecione" Value="" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:DropDownList runat="server" ID="ddlState" CssClass="form-control input-lg validate[required]" onchange="return getCities();">
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:DropDownList runat="server" ID="ddlCities" onchange="getCityId();" CssClass="form-control input-lg validate[required]">
                        </asp:DropDownList>
                    </div>
                </div>
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal17" Text='<%$Resources: Message, website %>' runat="server" /></label>
                    <div class="controls">
            ...
            <fieldset>
                ...
                <div class="control-group" id="div_user">
                    ...
                    <div class="controls">
                        <asp:TextBox runat="server" onblur="validate('user_login', 'div_user'); return false;" CssClass="form-control input-lg validate[required, maxSize[20]]" ID="txtuser" MaxLength="20" placeholder="Digite seu usuário"></asp:TextBox>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                    ...
                    <div class="controls">
                        <input type="password" class="form-control input-lg validate[required, minSize[6], maxSize[16]]" id="txtpassword" placeholder="Digite sua senha" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal16" Text='<%$Resources: Message, confirm_password %>' runat="server" /></label>
                    <div class="controls">
                        <asp:TextBox TextMode="Password" runat="server" CssClass="form-control input-lg validate[required,equals[txtpassword]]" ID="txtconfirmpassword" placeholder="Digite sua senha"></asp:TextBox>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal18" Text='<%$Resources: Message, photo %>' runat="server" /></label>
                    <div class="controls">
            ...
            <fieldset id="formorganizacao" style="display: none">
                ...
                <div class="control-group">
                    <hr />
                    <label class="control-label">
                        <asp:Literal ID="Literal22" Text='<%$Resources: Message, cnpj %>' runat="server" /></label>
                    <div class="controls">
                        <asp:TextBox runat="server" CssClass="form-control input-lg validate[required]" MaxLength="100" ClientIDMode="Static" ID="txtCnpj" placeholder='<%$Resources: Message, input_your_cnpj %>'></asp:TextBox>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal25" Text='<%$Resources: Message, representant_name %>' runat="server" /></label>
                    <div class="controls">
                ...
                <div class="form-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal26" Text='<%$Resources: Message, representant_email %>' runat="server" /></label>
                    <div class="controls">
                ...
                <div class="form-group">
                    <label class="control-label">
                        <asp:Literal ID="Literal27" Text='<%$Resources: Message, iam_accredited_entity %>' runat="server" /></label>
                    <div class="controls">
            ...
            <fieldset id="formTerms" style="display: none">
                ...
                <div class="form-group formTerms" style="display: none">
                    <hr />
                    <label class="control-label"></label>
                    <div class="controls">
                        <asp:CheckBox ID="chbTermsAccepted" runat="server" ClientIDMode="Static" Checked="false" />
                        <asp:Literal ID="Literal24" Text='<%$Resources: Message, agree_with_terms %>' runat="server" />
                    </div>
                </div>
            </fieldset>
        </div>
        <div class="row text-right">
            <asp:Label ID="lblerroterms" runat="server" Text=""></asp:Label><br />
            <asp:Button ID="btnSave" runat="server" CssClass="styler_bg_color" OnClientClick="return validateBeforeSave();" Text='<%$Resources: Message, register %>' OnClick="btnSave_Click" />
        </div>
    </div>
        ...
        function validateBeforeSave() {
            ...
            if ($('#chbCredenciada').is(':checked')) {
                if (!$('#chbTermsAccepted').is(':checked')) {
                    showAlert('<asp:Literal Text="<%$Resources: Message, agree_terms %>" runat="server" />', 'error', 3000);
